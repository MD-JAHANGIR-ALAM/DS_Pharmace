...
class FullCustomDropdownButtonForWithdrawFromApi extends StatelessWidget {
  const FullCustomDropdownButtonForWithdrawFromApi({
    super.key,
    this.baseColor,
    this.borderColor,
    this.errorColor,
                    ...
                    (val) {
                      return DropdownMenuItem<String>(
                          ...
                          value: val[id].toString() +
                              ...
                              "-" +
                              val[receiveMoney],
                          child: Text(val[name] + "-" + val[receiveMoney]));
                    },
                  ).toList(),
                  onChanged: (val) {
                    onChangeButton(val);
