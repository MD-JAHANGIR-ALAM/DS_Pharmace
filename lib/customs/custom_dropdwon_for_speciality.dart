...
class CustomDropdownForSpecialityButton extends StatelessWidget {
  const CustomDropdownForSpecialityButton({
    super.key,
    this.baseColor,
    this.borderColor,
    this.errorColor,
                  ...
                  items: titleList!.map(
                    (val) {
                      return DropdownMenuItem<String>(
                          value: val['specialitie'].toString(),
                          child: Text(
                            val['specialitie'].toString(),
                          ));
                    },
                  ).toList(),
                  onChanged: (val) {
